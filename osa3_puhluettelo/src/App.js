...
class App extends React.Component {
  ...
  nameInputChange(e) {
    const alreadyExists = this.state.persons.persons.filter((person) => {
  ...
  deletePerson(e) {
    ...
    const person = this.state.persons.persons.filter(person => person.id.toString() === id)
